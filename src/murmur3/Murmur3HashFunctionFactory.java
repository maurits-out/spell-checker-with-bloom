...
public class Murmur3HashFunctionFactory {

    public static Function<byte[], byte[]> create(int seed) {
        return new Murmur3HashFunction(seed);
    }

    private record Murmur3HashFunction(int seed) implements Function<byte[], byte[]> {
